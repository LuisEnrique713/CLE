...
use backend\models\PerfilAlumnos;

/**
 * PerfilAlumnosSearch represents the model behind the search form of `backend\models\PerfilAlumnos`.
 */
class PerfilAlumnosSearch extends PerfilAlumnos
{
    /**
     * {@inheritdoc}
     */
