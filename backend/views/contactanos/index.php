...
/** @var backend\models\search\ContactanosSearch $searchModel */
...
$this->title = Yii::t('app', 'Contáctanos');
...
.mGrid {
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'Nombre',
            'Correo',
            'Quejas_o_Sugerencias:ntext',
            [
                'class' => ActionColumn::className(),
                'urlCreator' => function ($action, Contactanos $model, $key, $index, $column) {
