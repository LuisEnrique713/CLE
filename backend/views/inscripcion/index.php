...
/** @var backend\models\search\InscripcionSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */


$this->title = Yii::t('app', 'Inscripción');
$this -> registerCss("
.text-dark {
...
.mGrid {
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, Inscripcion $model, $key, $index, $column) {
   ...
   'pjax' => true,
        ...
        'panel' => [
            'heading'=>$this->title,
            'type'=>'info',
            'before'=>Html::a(Yii::t('app', 'Crear Inscripción'), ['create'], ['class' => 'btn btn-success']),
