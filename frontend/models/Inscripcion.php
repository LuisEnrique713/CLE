...
class Inscripcion extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['Nombre_Del_Estudiante', 'matricula', 'Comprobante_De_pago', 'curso_id', 'perfil_id', 'nivel_id'], 'required'],
            [['curso_id', 'perfil_id', 'nivel_id'], 'integer'],
            [['Nombre_Del_Estudiante', 'matricula'], 'string', 'max' => 45],
            [['Comprobante_De_pago'], 'string', 'max' => 2500],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'Comprobante_De_pago' => Yii::t('app', 'Comprobante De Pago'),
